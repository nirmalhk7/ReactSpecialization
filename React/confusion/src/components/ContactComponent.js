...
import {Breadcrumb,FormFeedback, BreadcrumbItem, Form,Button, FormGroup, Label, Col,Input} from 'reactstrap';
...
class Contact extends Component{
    ...
    validate(firstname,lastname, email,telnum){
        ...
        if(this.state.touched.firstname && firstname.length <3 )
            errors.firstname=" Firstname too smaal";
        return errors;
    }
    handleSubmit(event){
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="feedback" name="email"
